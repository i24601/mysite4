			...
			<div id="board">
				<div id="read">
					<form action="#" method="get">
						...
						<a id="btn_modify" href="${pageContext.request.contextPath}/board/writeForm?page=${param.page}&str=${param.str}&no=${param.no}&order_no=${bVo.order_no}&depth=${bVo.depth}&group_no=${bVo.group_no}">답글달기</a>
						</c:if>
